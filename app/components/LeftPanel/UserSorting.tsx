...
import { selectBars, selectFilter, setCurrentBars, setFilter, setPopupInvisible } from "@/app/lib/redux";
import { useDispatch, useSelector } from "react-redux";

import { filterBars } from "@/app/lib/utils/filterBars";
...
const UserSorting = () => {
    ...
    return (
        <nav className="flex justify-between gap-4 sm:gap-8 text-sm items-start">
